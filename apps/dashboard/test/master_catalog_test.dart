...
import 'package:tandao_dashboard/master_catalog.dart';
import 'package:tandao_dashboard/workspace_modules.dart';
...
void main() {
  test('master catalogue exposes all categories and hundreds of apps', () {
    ...
    expect(ids.toSet().length, ids.length, reason: 'Every installable app ID must be unique');

    expect(workspaceModuleById['mc25_mining_operations']?.name, 'Mining Operations');
    expect(workspaceModuleById['mc30_ai_finance_analyst']?.name, 'AI Finance Analyst');
