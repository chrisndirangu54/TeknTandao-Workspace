...
test('shared workflow enforces auth, tenant scope, stock transaction, trial expiry, and replay handling', async () => {
  ...
  for (const appId of ['crm','inventory','pos','accounting']) await api.installApp.run(request({appId}));
